...
### L1
- `docs/基础/L1-初级/01-Java基础与集合.md`
- `docs/基础/L1-初级/02-并发与JVM入门.md`
- `docs/基础/L1-初级/03-SpringBoot-MySQL-Redis开发主线.md`
- `docs/基础/L1-初级/04-L1高频面试题与答题模板.md`

### L2
- `docs/进阶/L2-中级/01-并发进阶与线程池调优.md`
- `docs/进阶/L2-中级/02-JVM调优与线上排障.md`
- `docs/进阶/L2-中级/03-MySQL-Redis-MQ性能与可靠性.md`
- `docs/进阶/L2-中级/04-微服务治理与可观测性.md`

### L3
- `docs/进阶/L3-高级/01-高并发系统设计与容量规划.md`
- `docs/进阶/L3-高级/02-分布式一致性与事务方案.md`
- `docs/进阶/L3-高级/03-高可用与稳定性工程.md`
- `docs/进阶/L3-高级/04-架构演进与技术治理面试.md`

## 8. 学习与复习配套文档

- `docs/12-六周学习执行计划.md`
- `docs/13-面试题库编号与复习规则.md`
- `docs/基础/L1-初级/00-L1子章节索引.md`
- `docs/进阶/L2-中级/00-L2子章节索引.md`
- `docs/进阶/L3-高级/00-L3子章节索引.md`

## 9. 本轮细化进展（2026-03-05）

- L1 子章节（19/19）已全部落地，见 `docs/基础/L1-初级/00-L1子章节索引.md`。
- L2 子章节（18/18）已全部落地，见 `docs/进阶/L2-中级/00-L2子章节索引.md`。
- L3 子章节（16/16）已全部落地，见 `docs/进阶/L3-高级/00-L3子章节索引.md`。
