# L2-M4-S03 Trace/Logs/Metrics 协同

## 一句话结论

- Trace/Logs/Metrics 协同 是 L2 阶段的关键能力点，面试回答建议覆盖“定义、原理、场景、边界”。
...
### Q1：你如何在项目中落地“Trace/Logs/Metrics 协同”？
...
### Q2：Trace/Logs/Metrics 协同 的常见误区是什么？
...
- 示例代码：[`examples/l2/TraceIdLogDemo.java`](../../examples/l2/TraceIdLogDemo.java)
